...
| Name | Type |
|------|------|
| [azurerm_management_group.mg](https://registry.terraform.io/providers/hashicorp/azurerm/3.29.0/docs/resources/management_group) | resource |
| [azurerm_key_vault.key_vault](https://registry.terraform.io/providers/hashicorp/azurerm/3.29.0/docs/data-sources/key_vault) | data source |
| [azurerm_key_vault_secret.secrets](https://registry.terraform.io/providers/hashicorp/azurerm/3.29.0/docs/data-sources/key_vault_secret) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_mg_id"></a> [mg\_id](#output\_mg\_id) | ------------------------------------------ Output for Management ID ------------------------------------------ |
<!-- END_TF_DOCS -->