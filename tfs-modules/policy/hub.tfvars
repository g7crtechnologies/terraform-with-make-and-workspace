policy = {
  ...
  "Firewall enable IDPS" = {
    name                 = "Firewall enable IDPS"
  ...
  "Firewall premium enable" = {
    name                 = "Firewall premium enable"
