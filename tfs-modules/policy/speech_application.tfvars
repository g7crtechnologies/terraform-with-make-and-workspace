policy = {
  ...
  "MFA enable with write" = {
    name                 = "MFA enable with write"
  ...
  "VM SKU Allow" = {
    ...
    parameters = {
      "value" : ["Standard_D2s_v3", "Standard_D4s_v3", "Standard_DS1_v2", ]
    }
  }
  "Storage Restriction" = {
  ...
  "Cognitive be private" = {
    name                 = "Cognitive be private"
...
display_name = "mg-speech-application"
policy_rg = {
  "Require tag on resource" = {
    ...
    list                 = true
    parameters           = { "value" : "project_owner" },
    parameters2          = { "value" : "speech" }
    type                 = ""
  }
  "Require a tag on rg" = {
